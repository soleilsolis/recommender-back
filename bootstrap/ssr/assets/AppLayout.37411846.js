...
function AppLayout({
  ...
  if (((_a = page.props.auth.user) == null ? void 0 : _a.current_instance) != null) {
    if (((_b = page.props.auth.user) == null ? void 0 : _b.current_instance.exam.limit) != null && ((_c = page.props.auth.user) == null ? void 0 : _c.current_instance.exam.limit) > 0) {
      const form = useForm({
        current_instance_id: (_d = page.props.auth.user) == null ? void 0 : _d.current_instance.id
      });
      var countDownDate = moment((_e = page.props.auth.user) == null ? void 0 : _e.current_instance.created_at).add((_f = page.props.auth.user) == null ? void 0 : _f.current_instance.exam.limit, "m").toDate();
  ...
  return /* @__PURE__ */ jsxs("div", {
    children: [/* @__PURE__ */ jsx(Head, {
      ...
      children: [/* @__PURE__ */ jsxs("nav", {
                ...
                children: page.props.jetstream.hasTeamFeatures ? /* @__PURE__ */ jsx(Dropdown, {
                  ...
                  children: /* @__PURE__ */ jsx("div", {
                    ...
                    children: page.props.jetstream.hasTeamFeatures ? /* @__PURE__ */ jsxs(Fragment, {
                      children: [((_g = page.props.auth.user) == null ? void 0 : _g.type) === "admin" && /* @__PURE__ */ jsxs(Fragment, {
                        children: [/* @__PURE__ */ jsx("div", {
                          className: "block px-4 py-2 text-xs text-gray-400",
                          children: "Manage Classrooms"
                        }), /* @__PURE__ */ jsx(DropdownLink, {
                          href: route("teams.show", [(_h = page.props.auth.user) == null ? void 0 : _h.current_team]),
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [page.props.jetstream.managesProfilePhotos ? /* @__PURE__ */ jsx("div", {
                ...
                children: /* @__PURE__ */ jsx("img", {
                  ...
                  src: (_k = page.props.auth.user) == null ? void 0 : _k.profile_photo_url,
                  alt: (_l = page.props.auth.user) == null ? void 0 : _l.name
                })
              }) : null, /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsx("div", {
                  className: "font-medium text-base text-gray-800 dark:text-gray-200",
                  children: (_m = page.props.auth.user) == null ? void 0 : _m.name
                }), /* @__PURE__ */ jsx("div", {
                  className: "font-medium text-sm text-gray-500",
                  children: (_n = page.props.auth.user) == null ? void 0 : _n.email
                })]
              })]
            }), /* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsx(ResponsiveNavLink, {
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  href: route("teams.show", [(_o = page.props.auth.user) == null ? void 0 : _o.current_team]),
                  ...
                  className: "block px-4 py-2 text-xs text-gray-400",
                  children: "Switch Classrooms"
                }), (_q = (_p = page.props.auth.user) == null ? void 0 : _p.all_teams) == null ? void 0 : _q.map((team) => {
                  var _a2;
                  return /* @__PURE__ */ jsx("form", {
                    onSubmit: (e) => switchToTeam(e, team),
                    children: /* @__PURE__ */ jsx(ResponsiveNavLink, {
        ...
        children
      }), ((_r = page.props.auth.user) == null ? void 0 : _r.current_instance) && /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsxs(CardBody, {
              ...
              children: [/* @__PURE__ */ jsx(Spinner, {}), /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsx(Typography, {
                  ...
                  variant: "h6",
                  children: (_s = page.props.auth.user) == null ? void 0 : _s.current_instance.exam.name
                }), ((_t = page.props.auth.user) == null ? void 0 : _t.current_instance.exam.limit) !== null && ((_u = page.props.auth.user) == null ? void 0 : _u.current_instance.exam.limit) > 0 && /* @__PURE__ */ jsxs(Typography, {
                  variant: "h5",
                  children: [timer, " Left"]
                })]
              })]
