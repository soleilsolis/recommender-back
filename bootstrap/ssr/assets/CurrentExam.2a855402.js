...
function Show({
  ...
  useEffect(() => {
    form.data.instance_answer_id = instanceAnswers[0] != void 0 ? instanceAnswers[0].id : null;
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: /* @__PURE__ */ jsxs(CardBody, {
                children: [question.data[0].answers.map((answer) => /* @__PURE__ */ jsx(Fragment, {
                  ...
                  label: "Answer",
                  value: instanceAnswers[0] != void 0 ? instanceAnswers[0].value : "",
                  onChange: (event) => {
                    form.data.value = event.currentTarget.value;
                  },
                  children: instanceAnswers[0] != void 0 ? instanceAnswers[0].value : ""
                })]
              })
            })]
